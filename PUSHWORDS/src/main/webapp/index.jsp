...
<main class="main-content">
    <h1 style="color: rgb(248,246,231)">Testez vos compétences en anglais</h1>
    <div class="word-container" id="word-container"></div>
    <div class="keyboard" id="keyboard"></div>
    <div id="message" style="color: rgb(248,246,231)"></div>
</main>

<script>
    const words = [
        "algorithm", "function", "variable", "object", "array",
        "loop", "conditional", "inheritance", "polymorphism", "abstraction",
        "recursion", "compiler", "interpreter", "syntax", "debugging",
        "database", "encryption", "decryption", "network", "protocol",
    ...
    function guessLetter(letter) {
        if (selectedWord.includes(letter)) {
            ...
            if (mistakes >= maxMistakes) {
                document.getElementById('message').innerText = 'Sorry, you lost. The word was: ' + selectedWord;
                setTimeout(startGame, 2000);
            }
        }
    }
